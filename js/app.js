...
var yourName = 'David Ebinger';
var neighborName = 'Steven';
var teacherName = 'Vic';
...
var numberOfFloorsBurjKhalifa = 8;
var TokyoOlympicsYear = 20;
...
var japanPrefectures = ["Tokyo","Shinjuku","Osaka","Kyoto","Nara"];
...
india.splice(1,0, "Pankot Palace");
console.log(india);
...
var sameString = "Racecar" === "racecar";
console.log(sameString);
var sameNumber = "three" === 3;
...
console.log("Can they drink there?: ", drinkinAlready);
